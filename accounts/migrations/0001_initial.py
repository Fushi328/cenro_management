# Generated by Django 5.2.9 on 2026-01-29 06:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('STAFF', 'Staff'), ('CONSUMER', 'Consumer')], default='CONSUMER', max_length=20)),
                ('is_approved', models.BooleanField(default=False, help_text='For staff and consumer accounts that require admin approval.')),
